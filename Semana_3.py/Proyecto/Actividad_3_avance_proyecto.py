...
if input == si:
  print("Su problema es sobre switches\tporfavor dirigase a www.empresasupercool.com")
  break
...
print("\tPara mas informacion y asistencia dirigase a www.empresasupercool.com")
